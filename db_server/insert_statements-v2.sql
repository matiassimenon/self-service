...
-- MySQL
-- 8.0
INSERT INTO `self_service_db`.`TEMPLATE` (`template_uuid`, `template_name`, `username`, `creation_date`, `last_edit`) VALUES ('00000013', 'mysql8.0-ubuntu12.04-jdk8u151', 'fgalindo', '2018-05-29', '2018-05-29');
INSERT INTO `self_service_db`.`DB_TEMPLATE` (`template_uuid`, `os`, `os_version`, `db_version`, `db`) VALUES ('00000013', 'ubuntu', '12.04', '8.0', 'mysql');
-- 5.7
INSERT INTO `self_service_db`.`TEMPLATE` (`template_uuid`, `template_name`, `username`, `creation_date`, `last_edit`) VALUES ('00000014', 'mysql5.7-ubuntu14.04-jdk8u151', 'fgalindo', '2018-05-29', '2018-05-29');
INSERT INTO `self_service_db`.`DB_TEMPLATE` (`template_uuid`, `os`, `os_version`, `db_version`, `db`) VALUES ('00000014', 'ubuntu', '14.04', '5.7', 'mysql');
-- 5.6
INSERT INTO `self_service_db`.`TEMPLATE` (`template_uuid`, `template_name`, `username`, `creation_date`, `last_edit`) VALUES ('00000015', 'mysql5.6-ubuntu16.04-jdk8u151', 'fgalindo', '2018-05-29', '2018-05-29');
INSERT INTO `self_service_db`.`DB_TEMPLATE` (`template_uuid`, `os`, `os_version`, `db_version`, `db`) VALUES ('00000015', 'ubuntu', '16.04', '5.6', 'mysql');
-- 5.5
INSERT INTO `self_service_db`.`TEMPLATE` (`template_uuid`, `template_name`, `username`, `creation_date`, `last_edit`) VALUES ('00000016', 'mysql5.5-ubuntu17.10-jdk8u151', 'fgalindo', '2018-05-29', '2018-05-29');
...
INSERT INTO `self_service_db`.`DB_TEMPLATE` (`template_uuid`, `os`, `os_version`, `db_version`, `db`) VALUES ('00000020', 'centos', '7.1', '10.5', 'db2expressc');
