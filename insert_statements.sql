...
INSERT INTO `self_service_db`.`USER` (`email`, `username`, `department`, `admin`, `admin_request`,`city`, `firstname`, `lastname`, `password`, `region`) VALUES ('fgalindo@talend.com', 'fgalindo', 'rnd', '1', '1', 'atl', 'francisco', 'galindo', 'password', 'US');
INSERT INTO `self_service_db`.`USER` (`email`, `username`, `department`, `admin`, `admin_request`, `city`, `firstname`, `lastname`, `password`, `region`) VALUES ('adiallo@talend.com', 'adiallo', 'support', '0', '0', 'atl', 'abdoul', 'diallo', 'password', 'US');
INSERT INTO `self_service_db`.`USER` (`email`, `username`, `department`, `admin`, `admin_request`, `city`, `firstname`, `lastname`, `password`, `region`) VALUES ('nregonda@talend.com', 'nregonda', 'support', '0', '0', 'atl', 'nitesh', 'regonda', 'password', 'US');
INSERT INTO `self_service_db`.`USER` (`email`, `username`, `department`, `admin`, `admin_request`, `city`, `firstname`, `lastname`, `password`, `region`) VALUES ('aarnoult@talend.com', 'aarnoult', 'support', '0', '0', 'sur', 'anne', 'arnoult', 'password', 'EMEA');
INSERT INTO `self_service_db`.`USER` (`email`, `username`, `department`, `admin`, `admin_request`, `city`, `firstname`, `lastname`, `password`, `region`) VALUES ('klokala@talend.com', 'klokala', 'support', '0', '0', 'blr', 'karthick', 'lokala', 'password', 'APAC');
INSERT INTO `self_service_db`.`USER` (`email`, `username`, `department`, `admin`, `admin_request`, `city`, `firstname`, `lastname`, `password`, `region`) VALUES ('cchaumont@talend.com', 'cchaumont', 'escalation', '0', '0', 'irv', 'corinne', 'chaumont', 'password', 'EMEA');
INSERT INTO `self_service_db`.`USER` (`email`, `username`, `department`, `admin`, `admin_request`, `city`, `firstname`, `lastname`, `password`, `region`) VALUES ('djoshi@talend.com', 'djoshi', 'support', '0', '0', 'blr', 'dinesh', 'joshi', 'password', 'APAC');
INSERT INTO `self_service_db`.`USER` (`email`, `username`, `department`, `admin`, `admin_request`, `city`, `firstname`, `lastname`, `password`, `region`) VALUES ('hschueler@talend.com', 'hschueler', 'support', '0', '0', 'irv', 'harrison', 'schueler', 'password', 'US');
INSERT INTO `self_service_db`.`USER` (`email`, `username`, `department`, `admin`, `admin_request`, `city`, `firstname`, `lastname`, `password`, `region`) VALUES ('rohit.patel@talend.com', 'rohit.patel', 'support', '0', '0', 'atl', 'rohit', 'patel', 'password', 'US');
INSERT INTO `self_service_db`.`USER` (`email`, `username`, `department`, `admin`, `admin_request`, `city`, `firstname`, `lastname`, `password`, `region`) VALUES ('rpatel@talend.com', 'rpatel', 'support', '0', '0', 'blr', 'robin', 'patel', 'password', 'APAC');
...
INSERT INTO `self_service_db`.`TEMPLATE` (`template_uuid`, `template_name`, `username`, `creation_date`, `last_edit`, `os`, `os_version`, `jdk_version`, `jdk_update`) VALUES ('789012345', 'mysql57-ubuntu17-jdk8u151', 'hschueler', '2017-12-01', '2017-12-01', 'ubuntu', '17.04', '8', '151');
...
INSERT INTO `self_service_db`.`TEMPLATE` (`template_uuid`, `template_name`, `username`, `creation_date`, `last_edit`, `os`, `os_version`, `talend_version`, `talend_component`, `jdk_version`, `jdk_update`) VALUES ('901234567', 'cibuilder6341-ubuntu17-jdk8u144', 'rpatel', '2017-12-01', '2017-12-01', 'centos', '17.04', '6.4.1', 'cibuilder', '8', '144');
