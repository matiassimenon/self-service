...
RUN \
  ...
  mv /talend/<talend_installer_placeholder> /talend/jobserver-<talend_version_placeholder> && \
  rm -rf /talend/<talend_installer_placeholder>.zip

USER root
# Define Default command
ENTRYPOINT "/talend/jobserver-<talend_version_placeholder>/start_rs.sh" && /bin/bash
