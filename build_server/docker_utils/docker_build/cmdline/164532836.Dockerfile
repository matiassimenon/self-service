...
# Install cmdline
ADD Talend-Studio-20180116_1512-V6.5.1.zip /talend
ADD start_cmdline.sh /talend
ADD stop_cmdline.sh /talend
ADD telnet.jar /talend

RUN unzip /talend/Talend-Studio-20180116_1512-V6.5.1.zip && \
    mv /talend/Talend-Studio-20180116_1512-V6.5.1 /talend/cmdline && \
    rm -rf /talend/Talend-Studio-20180116_1512-V6.5.1.zip
