...
# Install jobserver
ADD Talend-JobServer-20180411_1414-V7.0.1.zip /talend

RUN \
  unzip /talend/Talend-JobServer-20180411_1414-V7.0.1.zip && rm -rf /talend/Talend-JobServer-20180411_1414-V7.0.1.zip \
  mv /talend/Talend-JobServer-20180411_1414-V7.0.1 /talend/jobserver-701 && \


USER root
# Define Default command
ENTRYPOINT "/talend/jobserver-701/start_rs.sh" && /bin/bash
