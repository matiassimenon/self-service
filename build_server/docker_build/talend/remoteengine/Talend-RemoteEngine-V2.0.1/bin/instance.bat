...
rem Commented by iPaaS build. setmem.bat used insted, called after :Check_JAVA_END label
rem if "%JAVA_MIN_MEM%" == "" (
...
rem  Commented by iPaaS build END
...
:Check_JAVA_END &REM Added setmem.bat call after this line by iPaaS build
...
set CLASSPATH=%KARAF_HOME%\system\org\apache\karaf\instance\org.apache.karaf.instance.core\4.1.1\org.apache.karaf.instance.core-4.1.1.jar
set CLASSPATH=%CLASSPATH%;%KARAF_HOME%\system\org\apache\karaf\shell\org.apache.karaf.shell.core\4.1.1\org.apache.karaf.shell.core-4.1.1.jar
set CLASSPATH=%CLASSPATH%;%KARAF_HOME%\system\org\ops4j\pax\logging\pax-logging-api\1.9.1\pax-logging-api-1.9.1.jar
