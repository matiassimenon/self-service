...
<table id="reg_form"  align="center" cellpadding="5px;" style="border:1px solid green;" >
		<tr>
                    <td class="td1">First Name:</td><td><input type="text" name="firstname" placeholder="First name" maxlength="30" required="required" value="<%=user.getFirstname()%>"></td>
		...
		<tr>
                    <td class="td1">Last Name:</td><td><input type="text" name="lastname"  maxlength="50" placeholder="Last name"  required="required" value="<%=user.getLastname()%>"></td>
                ...
                <tr>
                    <td class="td1">Username:</td><td> <input type="text" id="username" name="username" placeholder="Talend username" <%if(user.getUsername().length()>0){%> disabled <%}%>  maxlength="30" required="required" value="<%=user.getUsername()%>"></td>
                ...
                <tr>
                    <td class="td1">Talend Email:</td><td> <input type="email" name="email" placeholder="test@talend.com" pattern="[a-z0-9._%+-]+@talend.com" maxlength="50" required="required" value="<%=user.getEmail()%>"></td>
                    <td class="td1">Admin Request:</td><td><input type="checkbox" id="admin" name="admin"  value="true" <%if(user.isAdminRequest()){%>checked="checked" <%}%> ></td>
                </tr>
                
                <tr><td class="td1">Password:</td><td colspan="2"> <input type="password" id="password1" placeholder="password" name="password1" maxlength="20"  required="required" onkeyup="checkPasswd();" value="<%=user.getPassword()%>">
                     <input  style="width:230px;" type="password" maxlength="20" placeholder="Re-try password" id="password2" name="password2" required="required" onkeyup="checkPasswd();" value="<%=user.getPassword()%>"></td>
